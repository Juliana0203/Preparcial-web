        ...
        <form className="actor-form" onSubmit={handleSubmit}>
          <fieldset className="form-group">
            ...
            <div className="form-grid">
              <label>Título<input required value={movie.title} onChange={(event) => updateMovie('title', event.target.value)} /></label>
              ...
              <label>País<input required value={movie.country} onChange={(event) => updateMovie('country', event.target.value)} /></label>
          ...
          <fieldset className="form-group">
            ...
            <div className="form-grid">
              <label>Nombre<input required value={actor.name} onChange={(event) => updateActor('name', event.target.value)} /></label>
              ...
              <label>Nacionalidad<input required value={actor.nationality} onChange={(event) => updateActor('nationality', event.target.value)} /></label>
          ...
          <fieldset className="form-group">
            <legend>Premio de la película</legend>
            <div className="form-grid">
              <label>Nombre<input required value={prize.name} onChange={(event) => updatePrize('name', event.target.value)} /></label>
              <label>Categoría<input required value={prize.category} onChange={(event) => updatePrize('category', event.target.value)} /></label>
